const cardData = [
    ...
    },
    {
        ...
        text: "I passi principali per progettare un database si possono così schematizzare: 1. Analisi del problema; 2. Progettazione concettuale del database (*modello E-R*);3. Progettazione logica del database (*schema logico*); 4. Progettazione fisica e implementazione; 5. Realizzazione delle applicazioni Per la progettazione concettuale il modello più diffuso è L'**E-R** (*Entità-Relazione*)",
        style: { backgroundColor: 'rgba(150, 150, 255, 0.5)' }
    },
    {
        section: "Le Basi 1 - Cos'è un DB?",
    ...
    },
    {
        ...
        text: "È importante anche definire la <markblue>cardinalità</markblue> degli attributi di un'entità. La *cardinalità minima* puù essere **0** o **1**, **0** se è opzionale e **1** se l'attributo è obbligatorio. Invece la *cardinalità massima* è un numero compreso tra **1** ed ***n***. **1** se l'attributo è *monovalore* e ***n*** se è *multivalore*.",
        style: { backgroundColor: 'rgba(150, 150, 255, 0.5)' }
    },
    {
    ...
    },
    {
        ...
        text: "Nel modello E-R una **relazione** (o *associazione*) mette in comunicazione due o più entità. Viene spesso indicata con un verbo. Ogni relazione ha due versi con significati diversi:<br>• un'entità di partenza<br>• un'entità di arrivo<br>• una descrizione<br><span style='white-space: pre;'>     </span> Per esempio:<br><span style='white-space: pre;'>     </span>`[Persona] --- <abita> --- [indirizzo]`<br><span style='white-space: pre;'>     </span> Una persona abita ad un indirizzo<br><span style='white-space: pre;'>     </span> Un indirizzo è abitato da una persona<br>Le relazioni, come le entità, possono avere degli attributi.",
        style: { backgroundColor: 'rgba(150, 150, 255, 0.5)' }
    },
    {
        section: "Le relazioni nel modello E-R",
    ...
    },
    {
        ...
        id: "versione",
        title: "Versione",
        text: "Versione 0.1.28 - Beta relase",
        style: { backgroundColor: 'rgba(150, 150, 255, 0.5)' }
    },
];
