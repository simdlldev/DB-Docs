document.addEventListener('DOMContentLoaded', function() {
    ...
    if (isDesktopDevice()) {
        ...
        message.textContent = 'Sembra che tu stia utilizzando un computer desktop. Vuoi visualizzare la versione desktop del sito?';

        const goToDesktopButton = document.createElement('button');
        goToDesktopButton.textContent = 'Vai alla versione desktop';
        goToDesktopButton.addEventListener('click', function() {
            window.location.href = 'https://simdlldev.github.io/DB-Docs/web/main.html';
        });
        ...
        popupContent.appendChild(goToDesktopButton);
